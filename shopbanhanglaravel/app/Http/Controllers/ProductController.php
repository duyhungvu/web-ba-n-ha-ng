...
class ProductController extends Controller
{
         ...
         $get_image = $request->file('product_image');
            if($get_image){
             ...
             DB::table('tbl_product')->insert($data);
              Session::put('message','them thành công');
          ...
          DB::table('tbl_product')->insert($data);
            Session::put('message','them thương hiệu thành công');
          return Redirect::to('all-product');
    ...
    public function unactive_product($product_id){
        ...
        Session::put('message','không kích hoạt ');
    ...
    public function active_product($product_id){
        ...
        Session::put('message',' kích hoạt ');
    ...
    public function delete_product($product_id){
        ...
        Session::put('message',' xóa thành công');
        return Redirect::to('all-product');
    ...
    public function detail_product($product_id){
        ...
        ->with('product_detail',$detail_product)->with('related',$related_product );
    }
}
