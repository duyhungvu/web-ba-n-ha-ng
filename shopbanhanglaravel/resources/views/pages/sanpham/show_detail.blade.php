        ...
        <div id="similar-product" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <a href=""><img src="{{URL::to('public/font-end/images/similar1.jpg')}}" alt=""></a>
                    <a href=""><img src="{{URL::to('public/font-end/images/similar2.jpg')}}" alt=""></a>
                    <a href=""><img src="{{URL::to('public/font-end/images/similar3.jpg')}}" alt=""></a>
                </div>
            </div>
        ...
        <div class="tab-pane fade " id="reviews">
            <div class="col-sm-12">
                ...
                <form action="#">
                    ...
                    <b>Rating: </b> <img src="{{URL::to('public/font-end/images/rating.png')}}" alt="" />
