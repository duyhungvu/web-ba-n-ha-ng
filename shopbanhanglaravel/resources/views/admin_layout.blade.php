                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/add-category-product')}}">thêm sản phẩm</a></li>
                                <li><a href="{{URL::to('/all-category-product')}}">Liệt kê</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/all-brand-product')}}">Liệt kê thương hiệu</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
